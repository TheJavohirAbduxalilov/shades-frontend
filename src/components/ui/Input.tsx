...
const Input = ({ label, error, className, ...props }: InputProps) => {
  const inputClasses = [
    'w-full rounded-lg border px-4 py-3 text-sm outline-none transition-all duration-150 focus:border-primary-500 focus:ring-2 focus:ring-primary-500 active:ring-2 active:ring-primary-500',
